...
<script>
    window.onload = function(){
        //设置case_ number的值
        var case_number_value = "<?php echo ($data["case_number"]); ?>";
        $('input[name="case_number"]').val(case_number_value);

        var customer_value = "<?php echo ($data["customer"]); ?>";
        $('input[name="customer"]').val(customer_value);

        var recipients_value = "<?php echo ($data["recipients"]); ?>";
        $('input[name="recipients"]').val(recipients_value);

        var mobile_value = "<?php echo ($data["mobile"]); ?>";
        $('input[name="mobile"]').val(mobile_value);

        var address_value = "<?php echo ($data["address"]); ?>";
        $("#text_address").html(address_value);

        var remark_value1 = "<?php echo ($data["remark1"]); ?>";
        $('#text_remark1').val(remark_value1);
        
        var OfferPrice_value = "<?php echo ($data["OfferPrice"]); ?>";
        $('input[name="OfferPrice"]').val(OfferPrice_value);

        var NetPrice_value = "<?php echo ($data["NetPrice"]); ?>";
        $('input[name="NetPrice"]').val(NetPrice_value);

        var generality_value = "<?php echo ($data["generality"]); ?>";
        var generality = document.getElementById("generality");
        for(var i = 0; i<generality.length; i++){
            if(generality.options[i].value == generality_value){
                generality.options[i].selected = 'true';
                break;
            }
        }

        var BU_value = "<?php echo ($data["BU"]); ?>";
        var BU = document.getElementById("BU");
        for(var i = 0; i<BU.length; i++){
            if(BU.options[i].value == BU_value){
                BU.options[i].selected = 'true';
                break;
            }
        }

        var Sales_value = "<?php echo ($data["Sales"]); ?>";
        var Sales = document.getElementById("Sales");
        for(var i = 0; i<Sales.length; i++){
            if(Sales.options[i].value == Sales_value){
                Sales.options[i].selected = 'true';
                break;
            }
        }

        var PE_value = "<?php echo ($data["PE"]); ?>";
        var PE = document.getElementById("PE");
        for(var i = 0; i<PE.length; i++){
            if(PE.options[i].value == PE_value){
                PE.options[i].selected = 'true';
                break;
            }
        }

        var invoice_value = "<?php echo ($data["invoice"]); ?>";
        $('input[name="invoice"]').val(invoice_value);

        var invoice_date_value = "<?php echo ($data["invoice_date"]); ?>";
        $('input[name="invoice_date"]').val(invoice_date_value);

        var express_number_value = "<?php echo ($data["express_number"]); ?>";
        $('input[name="express_number"]').val(express_number_value);

        var express_date_value = "<?php echo ($data["express_date"]); ?>";
        $('input[name="express_date"]').val(express_date_value);

        var contact_date_value = "<?php echo ($data["contact_date"]); ?>";
        $('input[name="contact_date"]').val(contact_date_value);

        var pay_date_value = "<?php echo ($data["pay_date"]); ?>";
        $('input[name="pay_date"]').val(pay_date_value);

        var customer_payment_cycle_value = "<?php echo ($data["customer_payment_cycle"]); ?>";
        $('input[name="customer_payment_cycle"]').val(customer_payment_cycle_value);

        var remark_value3 = "<?php echo ($data["remark3"]); ?>";
        $('#text_remark3').val(remark_value3);
    }
</script>
...
<div class="container">
    ...
    <!-- ----------------------客户信息开始--------------------------------- -->
    <form action="/CFC/index.php/Home/Index/updateCustomerInfor/id/<?php echo ($data["id"]); ?>" method="post" id="form1">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <select class="form-control" name="generality" id="generality">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="customer"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="recipients"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="OfferPrice"  value="" onblur="setNetPrice()">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="mobile"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="NetPrice"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <textarea class="form-control" rows="1" placeholder="请填写收件地址..." name="address" id="text_address"></textarea>
            </div>
            <div class="col-md-3">
                <div class="input-group">
        ...
        <br />
						<div class="row">
							<div class="col-md-6">
								<textarea class="form-control" rows="1" placeholder="Remark" name="remark1" id="text_remark1"></textarea>
							</div>
						</div>
        <br />
        <div class="row">
    ...
    <!-- ----------------------快递信息开始--------------------------------- -->
    <form action="/CFC/index.php/Home/Index/updateExpressInfor/id/<?php echo ($data["id"]); ?>" method="post" id="form2">
        <hr class="feature-divider">
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    <span class="input-group-addon">*发票号码</span>
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="invoice"  value="">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" id="st1" class="form-control" aria-label="Amount (to the nearest dollar)" name="invoice_date"  value="">
                    <span class="input-group-addon">F</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="express_number"  value="">
                    <span class="input-group-addon">F</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" id="st2" class="form-control" aria-label="Amount (to the nearest dollar)" name="express_date"  value="">
                    <span class="input-group-addon">F</span>
                </div>
            </div>
        </div>
    ...
    <!-- ----------------------追踪日志开始--------------------------------- -->
    <form action="/CFC/index.php/Home/Index/updateTrackLog/id/<?php echo ($data["id"]); ?>" method="post" id="form3">
        <hr class="feature-divider">
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    <span class="input-group-addon">联系日期</span>
                    <input type="text" id="st3" class="form-control" aria-label="Amount (to the nearest dollar)" name="contact_date"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" id="st4" class="form-control" aria-label="Amount (to the nearest dollar)" name="pay_date"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="customer_payment_cycle"  value="">
                    <span class="input-group-addon">C</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                <textarea class="form-control" placeholder="Remark" id="text_remark3" name="remark3"></textarea>
            </div>
        </div>
        <br />
        <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="/CFC/index.php/Home/Index/status/id/<?php echo ($data["id"]); ?>"><input class="btn btn-danger btn-lg" type="submit" value="Close"></a>
        </div>
    </div>
    <br />
...
//        var time = '<?php echo (date("Y-m-d H:i:s", $data["time"])); ?>';
//        $("#text").html("Last modified by "+name+" on "+time);
//    }
    var name = '<?php echo session("name"); ?>';
    var time = '<?php echo (date("Y-m-d H:i:s", $data["time"])); ?>';
    $("#text").html("Last modified by "+name+" on "+time);
